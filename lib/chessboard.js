...
export const validateMove = (board, coordinates) => {
  ...
  const startPiece = getPosition(board, startPosition[0], startPosition[1]).piece;
...
// Set up jest - DONE
//  the tests for rook - DONE
// Try to implement validation for rook - DONE
// Assess moving on to ui or addressing each piece

// Note included rook logic for 'casting' - // The rook also participates, with the king, in a special move called castling.